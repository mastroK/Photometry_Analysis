...
RED_L_FIG_DIR = Path("figures_fixed_model_series_sm_red_l_truncated_fixed/final")
GREEN_L_FIG_DIR = Path("figures_fixed_model_series_sm_green_l_truncated_fixed/final")
OUT_DIR = RED_L_FIG_DIR

COLOR_RED = "#B8763E"
COLOR_GREEN = "#3B5B74"

# These beta_df.csv files were produced by a plot_pooled run that already
# applies both min_resid_dof (numerical-collapse guard) and
# min_retained_frac=0.5 (dwell-time-representativeness guard) inside
# fit_time_resolved_glm itself -- unlike the earlier truncated run, no
# post-hoc masking is needed here; the NaNs are already correct.
